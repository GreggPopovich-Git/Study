 ...
 <body topmargin="0" leftmargin="0">
   <table border="0" width="800">
     ...
     <p align = "center">
			<font size = 2>
			<!-- 목록보기 -->
			<input type = "button" value = "수정하기 " onClick = "location.href = 'guest_modify.jsp?idx=<%= idx %>'">&nbsp;&nbsp;
			<input type = "button" value = "삭제하기 " onClick = "guest_del('<%= idx %>')">&nbsp;&nbsp;
			<input type = "button" value = "목록으로 " onClick = "location.href = 'guest_list.jsp'">&nbsp;&nbsp;
			</font>
    </td>
  </tr>
  </table>
