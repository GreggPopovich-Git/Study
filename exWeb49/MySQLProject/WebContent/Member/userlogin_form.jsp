...
<script>
	function login() {
		...
		loginf.action = "userlogin_ok.jsp";
		loginf.submit();
	}
	function search() {
		window.open("id_search.jsp", "아이디 찾기", "width=330, height=220");
	}
	function passwd() {
		window.open("pw_search.jsp", "비밀번호찾기", "width=330, height=220");
	}
</script>
</HEAD>
				     ...
				     <tr bgcolor="#FFFFFF"> 
					   <td align=CENTER bgcolor="#eff4f8" height="92"> 
					     <table width="330" border="0" cellspacing="0" cellpadding="1">
							...
							<tr valign=bottom> 
							  ...
							  <td><a href = "javascript:login()"><img src="./img/login.gif" border=0 align=absmiddle></a></td>
							</tr>
						  </table>
						</td>
					  </tr>
					  <tr bgcolor="#FFFFFF"> 
						<td bgcolor="#ffffff" align=CENTER height="138"> 
							<a href = "javascript:search()">[아이디찾기]</a>&nbsp;&nbsp;<a href = "javascript:passwd()">[비밀번호찾기]</a>&nbsp;&nbsp;<a href = "userinfo_insert.jsp">[회원가입]</a>
						</td>
					  </tr>
					  <tr bgcolor="#FFFFFF"> 
						<td bgcolor="#ffffff" align=CENTER height="138"> 
