...
<div class="contain">
	...
	<form name="my" method="post" action="gallery_write.do">
		<table summery="갤러리 글쓰기 테이블 입니다">
			...
			<tbody>
					<tr>
						<th>카테고리</th>
						<td><input type="radio" name="type" value="국내여행">국내여행&nbsp;&nbsp;
							<input type="radio" name="type" value="해외여행">해외여행&nbsp;&nbsp;
							<input type="radio" name="type" value="맛집사진">맛집사진
						</td>
					</tr>
					<tr>
						<th>제목</th>
