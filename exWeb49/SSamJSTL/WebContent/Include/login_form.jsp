...
<script>
 ...
 <c:if test="${empty user }">
   ...
   <form name="leftlogin" action="userlogin.do" method="post" >
     <tr>
     ...
     <tr>
       <td><input type="image" src="/Member/img/login1.gif" border="0" onClick="return leftcheck()"></td>
			 <td>
           <a href="userinfo_insert.do"><img src="/Member/img/regist.gif" border="0"></a>
       </td>
     </tr>
 </form>
 </table>
 ...
 <table width="100%" height="120" border="0">
   ...
   <tr>
     <td align="center">
       ...
       <a href="userinfo_modify.do">[ 정보수정 ]</a><br>
       </font>
     </td>
   </tr>
 </table>
