								...
								<TD BGCOLOR=WHITE>
									<table cellspacing=0 cellpadding=0>
										<tr>
											...
											<td><a href="#" onClick="id_check()"><img src="/Member/img/u_bt01.gif" hspace=2 border=0 name=img1  align=absmiddle></a>
									...
									<table cellspacing=0 cellpadding=0>
										<tr>
											<td><input type=text name=zip size=6 maxlength=6 ></td>
                  							<td><a herf="#" onClick="post_check()"><img src="/Member/img/u_bt07.gif" hspace=2 border=0 name=img2 align=absmiddle></a></td>
										</tr>
									</table>
								</td>
							</tr>
