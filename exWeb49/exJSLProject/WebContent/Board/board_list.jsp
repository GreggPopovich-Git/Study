...
<style type="text/css">
	...
	* {margin:0; padding:0;}
	...
	.contents {background-color:#E6E6E6; padding:16px; height:600px;}
...
<!-- 본문의 시작 section  -->
	<div class="section">
		...
		<div class="content">
			...
			<form name="sort" action="board_list" method="post">
...
%>
					<tr class="text_center">
						<td><%= listcount-- %></td>
						<td><a href="board_view?idx=<%= list.get(x).getIdx() %>&page=${page}&sort=${sort}"><%= list.get(x).getSubject() %></a></td>
...
%>
				...
				<table style="border:0px">
					<tr>
						...
						<td style="border:0px;text-align:right;"><a href="board_write?page=${page}"><img src="img/write.gif" border="0"></a></td>
					</tr>
				</table>
