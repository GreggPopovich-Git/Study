...
<%
	List<BoardCommentVO> clist = null;
...
<style type="text/css">
	...
	* {margin:0; padding:0;}
	...
	.content {padding-bottom:100px;height:100%;}
...
<script>
	function del() {
		window.open("board_delete?idx=" + ${vo.idx} + "&page=" + ${page}, "board_delete", "width = 300, height = 200");
	}
	function cal() {
	...
	<div class="section">
		<section>
			<div class="content">
				...
				<table>
					<tr>
						<td colspan="2" style="border:0px;text-align:left;">●작성일자 : ${vo.regdate} &nbsp; ●조회수 : ${vo.readcnt}
						</td>
					</tr>
					<tr>
						<th>작성자</th>
      ...
      <!-- 답글쓰기 -->
       <a href="board_reply?page=${page}&idx=${vo.idx}">
       <img src="img/reply.gif" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
      <!-- 수정하기 -->
       <a href="board_modify?idx=${vo.idx}&page=${page}&sort=${sort}">
       <img src="img/edit.gif" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
         <!-- 삭제하기 -->
       <a href="javascript:del()"><img src="img/del.gif" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
       <!-- 목록보기 -->
       <a href="board_list?page=${page}&sort=${sort}"><img src="img/list-2.gif" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
      </font>
						</td>
					</tr>
				</table>
				...
				<input type="hidden" name="idx" value="${vo.idx}">
				<input type="hidden" name="page" value="${page}">
				<input type="hidden" name="compage" value="${compage}">
				<input type="hidden" name="sort" value="${sort}">
				<table>
					<tr>
						<td style="width:80%">
