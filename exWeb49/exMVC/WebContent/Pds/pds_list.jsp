...
<%@ include file="/Include/login_form.jsp" %>
	...
	<c:forEach var="list" items="${list}">
      <tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
		...
		<td align="left" height="20">&nbsp;<font face="돋움" size="2"><a class="list" href="/Pds?cmd=pds_view&idx=${list.idx}&page=${page}">${list.subject }</a></font></td>
   ...
   <tr>
	...
	<form name="pds" method="post" action="/Pds?cmd=pds_list" >	
