...
<html>
 ...
 <link rel="stylesheet" type="text/css" href="/stylesheet.css">
   ...
   function del_list() {
	   var urlString;
	   urlString = "/Pds?cmd=pds_delete&idx=${pds.idx}&page=${page}" ;
	 ...
	 function pds_down(url){
	    ...
	    location.href = "/Pds?cmd=pds_down&filename="+escapeURL;
	}
   </script>
 </head>
...
<%@ include file="/Include/login_form.jsp" %>
     ...
     <table border="0" width="90%" align="center" cellspacing="0" style="border-width:1px;border-color:#0066cc;border-style:outset;">
      ...
      <p align="center">
      <font size="2">
        <a href="/Pds?cmd=pds_modify&idx=${pds.idx}&page=${page}">
         <img src="Pds/img/edit-1.gif" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
       <a href="javascript:del_list();"><img src="Pds/img/del.gif" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
       <a href="/Pds?cmd=pds_list&page=${page}"><img src="Pds/img/list-2.gif" border="0"></a></font>
     </td>
  </tr>  
</table>  
</body>  
