...
<%@ page import = "dao.board.*, vo.board.*, java.util.*, util.*" %>
...
<%
	...
	int listcount = totcount - ((nowpage - 1) * maxlist); // 임시 글번호 출력용
...
<script>
	function search() {
		...
		bSearch.action = "board_list2.jsp";
		bSearch.submit();
	}
</script>
</head>
...
%>
		<tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
			...
			<td align="left" height="20">&nbsp;
				...
				<a class="list" href="board_view2.jsp?idx=<%= list.get(x).getIdx() %>&page=<%= nowpage %>"><%= list.get(x).getSubject() %></a></td>
...
%>
	...
	<table width="600">
		<tr>
			...
			<a href="board_write2.jsp?page=<%= nowpage %>"><img src="./img/write.gif" border="0"></a>
			</td>
		</tr>
	</table>
</body>
