   ...
   <style type="text/css">
	...
	<script>
	   	function board_del(idx) {
			window.open("board_delete2.jsp?idx=" + idx + "&page=" + nowpage, "board_delete", "width = 300, height = 200");
	   	}
   </script>
 </head>
