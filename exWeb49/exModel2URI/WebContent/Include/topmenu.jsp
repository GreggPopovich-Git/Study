...
<html>
 ...
 <table border="0" cellspacing="2" bgcolor="#ecf1ef" width="900" bordercolordark="#ffffff" bordercolorlight="#000000">
   <tr>
     ...
     <p align="center"><font color="white" size="2"><b><a href="/Member/userlogin.do" class="white">로그인</A></b></font></p>
     </c:if>
     <c:if test="${!empty user}">
     <p align="center"><font color="white" size="2"><b><a href="/Member/logout.do" class="white">로그아웃</A></b></font></p>
     </c:if>
     </td>
     <td bgcolor="#9966ff" width="10%" onmouseover="style.backgroundColor='#2772D3'" onmouseout="style.backgroundColor=''">
     <c:if test="${empty user}">     
     <p align="center"><font color="white" size="2"><b><a href="/Member/userinfo_insert.do" class="white">회원가입</a></b></font></p>
     </c:if>
     <c:if test="${!empty user}">
     <p align="center"><font color="white" size="2"><b><a href="/Member/userinfo_modify.do" class="white">정보수정</a></b></font></p>
     </c:if>
     </td>
     <td bgcolor="#9966ff" width="10%" onmouseover="style.backgroundColor='#2772D3'" onmouseout="style.backgroundColor=''">
     ...
     <td bgcolor="#9966ff" width="10%" onmouseover="style.backgroundColor='#2772D3'" onmouseout="style.backgroundColor=''">
     <p align="center"><font color="white" size="2"><b><a href="/Gallery/gallery_list.do" class="white">포토겔러리</a></b></font></p>
     </td>
     <td bgcolor="#9966ff" width="10%" onmouseover="style.backgroundColor='#2772D3'" onmouseout="style.backgroundColor=''">
