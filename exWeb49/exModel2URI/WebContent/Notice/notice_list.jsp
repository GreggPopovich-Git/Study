	...
	<c:forEach var="notice" items="${list}">
		<tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
			...
			<td align="left" height="20">&nbsp;     
				...
				<a class="list" href="notice_view.do?idx=${notice.idx}&page=${page}">${notice.subject}</a></td>
					<td align="center" height="20"><font face="돋움" size="2">
					<a class="list" href="mailto:ein1027@nate.com">${notice.name}</a></font></td>
	...
	<table width="600">
		<tr>
			...
			<td width="50%" align="center">
				<table>
					<form name="notice" method="post" action="notice_list.do">	
					<!-- 검색어를 이용하여 글제목, 작성자, 글내용 중에 하나를 입력 받아 처리하기 위한 부분 -->
						<tr>
							...
							<td> <a href="javascript:b_search()"><img src="./img/search2.gif" border="0"></a></td>
						</tr>
					</form>
				</table>
			</td>
			<td width="25%" align="right">
			<a href="notice_write.do?page=${page}"><img src="./img/write.gif" border="0"></a>
			</td>
		</tr>
	</table>
</body>
