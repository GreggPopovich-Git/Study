...
<html>
   ...
   function check(){
	   alert("자료를 등록합니다");
	   pds.action="pds_write_pro.do?page=${page}";
	   pds.submit();
   }
   </script>
   </head> 
	  ...
	  <table border="0" >
       ...
       <tr>
		...
		<tr></tr>			<tr></tr>
          ...
          <td align=center>
			<a href="javascript:check()"><img src="./img/purple_save.gif" width="56" height="18" border="0"></a>
			<a href="javascvript:reset()"><img src="./img/purple_cancle.gif" width="56" height="18" border="0"></a>
		  </td>
        </tr>
      </table>
    </td>
