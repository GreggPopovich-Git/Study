...
<%@ page import = "java.util.*, exServlet.model.guest.*" %>
<%
  ...
  <tr>
    ...
    <table border="0" cellspacing="1" width="100%" align="center">
      ...
      <tr>
		...
		<font size="2" face="고딕">전체 : ${totcount}</b>건 - ${totpage} Pages</font></td></tr>
 	   <tr bgcolor="e3e9ff">
...
%>
		<tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
          ...
          <td align="left" height="20"><font face="돋움" size="2" color="#000000"><a class="list" href="guest_view?page=${page}&idx=<%= list.get(x).getIdx() %>"><%= list.get(x).getSubject() %></a></font></td>
