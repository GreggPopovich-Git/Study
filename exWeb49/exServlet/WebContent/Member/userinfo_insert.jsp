						...
						<table cellpadding=3 cellspacing=1 border=0 width=100%>
							...
							<tr>
								...
								<TD BGCOLOR=WHITE>
									<table cellspacing=0 cellpadding=0>
										<tr>
											<td align=absmiddle>
												<input type=text name=userid size=12 maxlength=16 value="" style="width:150" placeholder = "중복검사를 해주세요." readonly>
											</td>
							...
							<tr>
								...
								<TD BGCOLOR=WHITE>
									<table cellspacing=0 cellpadding=0>
										<tr>
											<td><input type=text name=zipcode size=6 maxlength=6 style="width:180" placeholder = "우편번호찾기를 해주세요." readonly></td>
