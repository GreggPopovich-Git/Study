					...
					<td bgcolor="#7AAAD5">            
						...
						<table cellpadding=3 cellspacing=1 border=0 width=100%>
							...
							<tr>
								...
								<TD BGCOLOR=WHITE>
									<table cellspacing=0 cellpadding=0>
										<tr>
											<td align=absmiddle>
												<input type=text name=userid size=12 maxlength=16 value="<%= vo.getUserid() %>" style="width:150" readonly>
											</td>
										</tr>
									</table>
								</td>
							...
							<tr>
								...
								<TD BGCOLOR=WHITE>
									<input type=radio name=gubun value = "직장" <% if(vo.getGubun().equals("직장")) { %> checked <% } %>>직장&nbsp;&nbsp;
									<input type=radio name=gubun value = "자택" <% if(vo.getGubun().equals("자택")) { %> checked <% } %>>자택 
								</td>
							</tr>
							...
							<tr>
								...
								<TD BGCOLOR=WHITE>
									<table cellspacing=0 cellpadding=0>
										<tr>
											<td><input type=text name=zipcode size=6 maxlength=6 style="width:180" value = "<%= vo.getZipcode() %>" readonly></td>
							...
							<tr>
								...
								<TD BGCOLOR=WHITE>
									<input type=text name=addr1 size=50 maxlength=100 value="<%= vo.getAddr1() %>" readonly>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td bgcolor=WHITE valign=middle> 
									<input type="checkbox" name="fa" value="건강" <% if(vo.getFavorite().contains("건강")) { %> checked <% } %>>건강 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="checkbox" name="fa" value="문화예술" <% if(vo.getFavorite().contains("문화예술")) { %> checked <% } %>>문화예술 &nbsp;&nbsp;
									<input type="checkbox" name="fa" value="경제" <% if(vo.getFavorite().contains("경제")) { %> checked <% } %>>경제 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="checkbox" name="fa" value="연예오락" <% if(vo.getFavorite().contains("연예오락")) { %> checked <% } %>>연예오락 &nbsp;
									<input type="checkbox" name="fa" value="뉴스" <% if(vo.getFavorite().contains("뉴스")) { %> checked <% } %>>뉴스
									<br><input type="checkbox" name="fa" value="여행레져" <% if(vo.getFavorite().contains("여행레져")) { %> checked <% } %>>여행레져 &nbsp;&nbsp;
									<input type="checkbox" name="fa" value="생활" <% if(vo.getFavorite().contains("생활")) { %> checked <% } %>>생활 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="checkbox" name="fa" value="스포츠" <% if(vo.getFavorite().contains("스포츠")) { %> checked <% } %>>스포츠 &nbsp;&nbsp;
									<input type="checkbox" name="fa" value="교육" <% if(vo.getFavorite().contains("교육")) { %> checked <% } %>>교육 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="checkbox" name="fa" value="컴퓨터" <% if(vo.getFavorite().contains("컴퓨터")) { %> checked <% } %>>컴퓨터 &nbsp;&nbsp;
									<input type="checkbox" name="fa" value="학문" <% if(vo.getFavorite().contains("학문")) { %> checked <% } %>>학문 &nbsp;&nbsp;
								</td>
							</tr>
							<tr>
								...
								<TD BGCOLOR=WHITE>
									<select name=job class="formbox">
 										...
 										<option value="회사원" <% if(vo.getJob().equals("회사원")) { %> selected <% } %>>회사원
 										<option value="연구전문직" <% if(vo.getJob().equals("연구전문직")) { %> selected <% } %>>연구전문직
 										<option value="교수학생" <% if(vo.getJob().equals("교수학생")) { %> selected <% } %>>교수학생
 										<option value="일반자영업" <% if(vo.getJob().equals("일반자영업")) { %> selected <% } %>>일반자영업
 										<option value="공무원" <% if(vo.getJob().equals("공무원")) { %> selected <% } %>>공무원
 										<option value="의료인" <% if(vo.getJob().equals("의료인")) { %> selected <% } %>>의료인
 										<option value="법조인" <% if(vo.getJob().equals("법조인")) { %> selected <% } %>>법조인
 										<option value="종교,언론,에술인" <% if(vo.getJob().equals("종교,언론,에술인")) { %> selected <% } %>>종교.언론/예술인
 										<option value="농,축,수산,광업인" <% if(vo.getJob().equals("농,축,수산,광업인")) { %> selected <% } %>>농/축/수산/광업인
 										<option value="주부" <% if(vo.getJob().equals("주부")) { %> selected <% } %>>주부
 										<option value="무직" <% if(vo.getJob().equals("무직")) { %> selected <% } %>>무직
 										<option value="기타" <% if(vo.getJob().equals("기타")) { %> selected <% } %>>기타
									</select>
								</td>                
							</tr>
							<tr>
						...
						<table cellpadding=0 cellspacing=0 border=0 width=100%>
							...
							<tr bgcolor=#ffffff>
								<td colspan=3 align=center>
									...
									<a href = "userinfo_insert"><img src="Member/img/u_bt05.gif" border=0 hspace=10 vspace=3 name=img4></a>
								</td>
							 </tr>
						</table> 
					</td>
