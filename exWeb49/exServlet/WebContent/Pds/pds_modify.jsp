...
<form name = "pds" method = "post" enctype = "multipart/form-data">
   ...
   <table border="0">
    ...
    <tr>
      ...
      <td><input type="file" name="filename" size="30" value = "${vo.filename}">
<%
	if(vo.getFilename() != null) {
%>
      <img src="Pds/img/disk.gif" align="middle" width="22" height="20" border="0">${vo.filename}</td></tr>
<%
	}
%>
    <tr>
