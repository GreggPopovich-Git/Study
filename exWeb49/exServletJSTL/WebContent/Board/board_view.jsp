...
<%@ include file = "/Include/login_form.jsp" %>
       ...
       <table border="0" width="90%" align="center" cellspacing="0"  style="border-width:1px;border-color:#0066cc;border-style:outset;">
         <tr bgcolor="e3e9ff">
           <td class="title">
             <img src="Board/img/bullet-04.gif"> <font size="2" face="돋움">${board.subject}</font>
           </td>
         </tr>
         <tr>
           <td class="content">
      ...
      <font size="2">
	   ...
	   <!-- 수정하기 -->
       <a href="board_modify.do?page=${page}&idx=${board.idx}">
       <img src="Board/img/edit.gif" border="0"></a>&nbsp;&nbsp;
         <!-- 삭제하기 -->
       <a href="board_delete.do?page=${page}&idx=${board.idx}"><img src="Board/img/del.gif" border="0"></a>&nbsp;&nbsp;
       <!-- 목록보기 -->
