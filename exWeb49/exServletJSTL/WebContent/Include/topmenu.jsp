 ...
 <table border="0" cellspacing="2" bgcolor="#ecf1ef" width="900" bordercolordark="#ffffff" bordercolorlight="#000000">
   <tr height="50px">
     <td width="20%" rowspan="4" valign="bottom" bgcolor="#000000">
       ...
       <font style="font-size:9pt;color:white;font-family:돋움"><b>Total ${tot}
     ...
     <c:if test="${empty vo}">
     <p align="center"><font color="white" size="2"><b><a href="login_form.do" class="white">로그인</A></b></font></p>
     </c:if>
     <c:if test="${!empty vo}">
