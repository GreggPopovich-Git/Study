...
<TR>
  <TD width=100>&nbsp;</td>
  <TD>
  <form name=fname method=post onSubmit="return false;">
					   ...
					   <td align=CENTER bgcolor="#eff4f8" height="92"> 
					     <table width="330" border="0" cellspacing="0" cellpadding="1">
							...
							<tr valign=bottom> 
							  ...
							  <td nowrap>비밀번호</td>
							  <td>: 
								<input type=password name="passwd" size=14 maxlength=12 STYLE="WIDTH:155" onKeyUp="autoSubmitRight()">
							  </td>
							  <td><a href="javascript:onCheck()"><img src="Member/img/login.gif" border=0 align=absmiddle></a></td>
							</tr>
						  </table>
						</td>
					  </tr>
